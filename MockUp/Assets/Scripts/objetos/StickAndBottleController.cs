...
public class StickAndBottleController : MonoBehaviour
{
	...
	{
		// Calcular la velocidad deseada limitada a la m�xima permitida
	...
	{
		// Calcular la direcci�n deseada hacia el objetivo
	...
	private void OnCollisionEnter(Collision other)
	{
		if (other.gameObject.name == "Corriente")
		{
			...
			// Ajustar la posici�n utilizando el Rigidbody
